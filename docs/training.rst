...
5. Go to 3.
6. Once *validation accuracy* is sufficient, copy the coefficients into your ruleset, and use the Evaluate function of FathomFox on a fresh set of *testing* samples. This is your *testing accuracy* and should reflect real-world performance, assuming your sample size is large and representative enough. The computed 95% confidence intervals should help you decide the former. (The commandline trainer will soon gain this functionality, much more RAM-efficiently than FathomFox.)
